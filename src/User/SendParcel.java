...
public class SendParcel extends javax.swing.JFrame {
    ...
    public SendParcel() {
        ...
        initComponents();
        Sender1.setText(Session.getName());
    ...
    private void initComponents() {
        ...
        jPanel3.add(Weight, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 320, 270, -1));
        ...
        jPanel3.add(registerpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 610, 140, 40));
        ...
        jPanel3.add(Receiver, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 500, 270, -1));
        ...
        jPanel3.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 610, 90, 40));
        ...
        jPanel3.add(Receiver1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 560, 270, -1));
        ...
        Sender1.setText(" ");
        Sender1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Sender1ActionPerformed(evt);
            }
        });
        jPanel3.add(Sender1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 380, 270, -1));
        ...
        jPanel3.add(Weight1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 260, 270, -1));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 420, 700));
 ...
 config con = new config();
    ...
    String pWeight = Weight1.getText().trim();   
    String pAmount = Weight.getText().trim();    
    String sName = Sender1.getText().trim();     
    String sAddress = Sender.getText().trim();   
    String rName = Receiver.getText().trim();    
    String rAddress = Receiver1.getText().trim(); 
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
        userdashboard Back = new userdashboard();
    ...
    private void Sender1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Sender1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Sender1ActionPerformed
